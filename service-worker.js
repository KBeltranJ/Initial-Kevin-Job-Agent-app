const CACHE="kevin-job-agent-v8";
const ASSETS=["./","./index.html","./styles.css","./custom-jobs.css","./applied-search.css","./app.js","./sync.js","./custom-jobs.js","./applied-search.js","./manifest.webmanifest","./jobs.json","./icons/icon-192.png","./icons/icon-512.png","./icons/maskable-512.png"];
