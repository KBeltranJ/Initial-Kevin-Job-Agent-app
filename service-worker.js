const CACHE="kevin-job-agent-v6";
const ASSETS=["./","./index.html","./styles.css","./custom-jobs.css","./app.js","./sync.js","./custom-jobs.js","./manifest.webmanifest","./jobs.json","./icons/icon-192.png","./icons/icon-512.png","./icons/maskable-512.png"];
